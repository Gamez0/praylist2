...
package com.praylist.socialcomponents.main.main;
...
import com.praylist.socialcomponents.main.search.SearchActivity;
...
//            }
    ...
    @Override
    public void showLikeCounter(boolean show) {// 여기 좋아요 수 구현안해도 될듯!
